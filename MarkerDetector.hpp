...
public:
  ...
  void ChangeMarkerSize(float largeSize,float smallSize,float frontSize);

  double xPoints,yPoints,yPointFront;
...
private:
  ...
  std::vector<cv::Point3f> m_markerCorners3d,largeMarker3d,smallMarker3d,frontMarker3d;
